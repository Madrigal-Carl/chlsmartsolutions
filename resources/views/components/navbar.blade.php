<nav x-data="{ open: false }" class="flex items-center justify-between w-full font-inter bg-black py-6 md:px-6 relative">
    ...
    <div x-show="open" x-cloak @click.outside="open = false" x-transition
        ...
        <button class="flex items-center gap-2 p-2 border-b border-[#DCDCDC] last:border-none">
        ...
        <button class="flex items-center gap-2 px-2 py-3 border-b border-[#DCDCDC] last:border-none">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                stroke="currentColor" class="size-5">
                <path stroke-linecap="round" stroke-linejoin="round"
